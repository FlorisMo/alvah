...
// Strong, explicit A-pose with arms CLEARLY away from the torso — the key fix.
const PROMPT =
  'full body 3D game character of a friendly 8 year old Dutch forest ranger boy, ' +
  ...
  'warm friendly face, stylized realistic, clean topology, rig ready, ' +
