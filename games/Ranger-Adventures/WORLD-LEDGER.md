...
- [x] W5.1 Jeep bestuurbaar: Stap in/uit, arcade-kinematisch, ruimere camera; reduced-motion: snelheid ~3 m/s en halve draaisnelheid; E2E rijdt ≥10 m + caps gelden (3)
- [x] W5.2 Jeep-gevoel: zachte motorloop, stof (uit onder reduced-motion), auto-langzaam bij dieren (2)
...
- [x] W6.2a rmSafe-audit corsi3d: cuts-niet-moves waar eerlijk kan; flip vereist reduced-motion E2E (nul camera-beweging) + §10-notitie; bij twijfel rmSafe:false HOUDEN (1)
- [x] W6.2b rmSafe-audit simon3d: zelfde eisen als W6.2a (1)
- [x] W6.2c rmSafe-audit zoeken3d: zelfde eisen als W6.2a (1)
- [x] W6.2d rmSafe-audit wisselen3d: zelfde eisen als W6.2a (1)
W6.3 Biologie diegetisch — gesplitst (raaf vertelt op locatie / veldnotitie op het prikbord, elk eigen E2E):
...
- [x] W6.5 Toon-gate: nieuwe strings in readlevel-corpus, voorlezen gekoppeld, ≥56 px E2E-assert (1)

## Fase W7 — Prestatie + oplevering

- [x] W7.1 Code-splitting: vendor chunk + lazy chunks; /ranger/app.js entrynaam ongewijzigd; entry gzip <120 kB (2)
- [x] W7.2 Kwaliteits-tiers via fps-probe (pixelRatio, vegetatiedichtheid) met hysterese; persist via state.ts (2)
- [x] W7.3 Alles groen: unit + parity + volledige E2E (chromium én webkit) + build:site + astro build; AUTO-QA-REPORT-2.md met screenshots uit qa-evidence-2/ (2)
- [x] W7.4 Ship: commit + push; E2E tegen astro preview met vooraf gezette sessionStorage gate-sleutel; curl 200 + app.js hash gewijzigd (1)
