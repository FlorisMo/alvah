...
- Welke ON3-interventies lopen nu (BOUW!, extra lezen, extra rekenen, anders)?
- Hoeveel minuten per week, over welke periode?
- Wie voert het uit en is die persoon gekwalificeerd?
- Hoe wordt voortgang gemeten (tussen de Cito-momenten in)?

Zie [/doubleren](/doubleren) voor waarom deze data ertoe doet.
