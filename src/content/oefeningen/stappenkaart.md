...
Een kaart of briefje met een taak die uit meerdere stappen bestaat, elke stap afzonderlijk afgevinkt. Bijvoorbeeld "huiswerk maken":

1. Tas uit
2. Agenda openen
3. Kijken wat er moet
4. Eerste taak kiezen
5. Materiaal pakken
6. Aan tafel zitten
7. Starten

Wat voor een neurotypisch kind één vanzelfsprekende handeling is ("huiswerk maken"), bestaat voor een kind met EF-zwakte uit zeven losse beslissingen die allemaal energie kosten.

## Waarom het werkt

Task analysis is een kernmethode in Dawson &amp; Guare's scaffolding-model. Door de taak op te breken:
