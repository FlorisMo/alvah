---
titel: "Cogmed Werkgeheugentraining"
domein: ["werkgeheugen"]
context: ["thuis", "specialist"]
...
- Melby-Lervåg &amp; Hulme (2013): geen transfer naar reading, maths, of reasoning

Dit is <em>geen onbetekenende methode</em>, maar de claims over schooldienst zijn overdreven.

## Hoe doen we dit

Als jullie toch willen proberen:
- Via een daarin getrainde psycholoog of orthopedagoog.
- Licentie ~€300–600. Vaak NIET vergoed bij reguliere dyslexie / EF-zwakte.
- 5 weken commitment, dagelijkse sessie.
- Houd vast: Alvah wordt beter in de app. Verwacht geen wonderen op rapport.

Alternatief met betere evidence: <strong>Beweging</strong> (Cerrillo-Urbina 2015, g=0.4–0.6 op ADHD-aandacht) of <strong>BBdL</strong> (zie [beter-bij-de-les](/oefeningen/#beter-bij-de-les)).
