---
titel: "BOUW!"
domein: ["technisch-lezen", "spelling"]
...
BOUW! is een computerondersteund leer-lees-programma, ontwikkeld in Nederland, voor kinderen van groep 2 tot halverwege groep 4 die risico lopen op dyslexie. Het kind werkt met een tutor (ouder, oma, maatje of leerkrachtondersteuner) aan de computer. Het programma geeft directe feedback en bouwt stapsgewijs op.

## Waarom het werkt

De meest robuuste Nederlandse evidence voor een leesinterventie. Van der Weijden (UvA, 2024) toonde in een grootschalige studie aan dat correct ingezette BOUW! leidt tot:
